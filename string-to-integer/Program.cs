...
public class Solution
{
    public int MyAtoi(string s)
    {
        ...
        while (i < n && char.IsDigit(s[i]))
        {
            ...
            // 4. Comprobar overflow/underflow antes de multiplicar por 10
...
class Program
{
    static void Main()
    {
        ...
        // Ejemplos dados
        Console.WriteLine(solution.MyAtoi("42"));           // 42
        Console.WriteLine(solution.MyAtoi("   -042"));      // -42
        Console.WriteLine(solution.MyAtoi("1337c0d3"));     // 1337
        Console.WriteLine(solution.MyAtoi("0-1"));          // 0
        Console.WriteLine(solution.MyAtoi("words and 987"));// 0

        // Entrada personalizada
        Console.WriteLine("Introduce una cadena para convertir a entero:");
        string? input = Console.ReadLine();
        if (input != null)
            Console.WriteLine($"Resultado: {solution.MyAtoi(input)}");
    }
}